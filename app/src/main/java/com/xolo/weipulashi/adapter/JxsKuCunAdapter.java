...
public class JxsKuCunAdapter extends CommenAdapter<StockNum> {
    public JxsKuCunAdapter(Context context) {
        super(context);
    }
    ...
    public void setView(ViewHolder holder, int position, StockNum stockNum) {
        ...
        holder.setText(R.id.tv_store, stockNum.getBranchName());
    }

    @Override
    public int getLayoutID() {
        return R.layout.item_jxs_ku_cun;
    }
}
